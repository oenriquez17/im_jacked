...
const get_exercise_details = 'SELECT e.Name AS name, MAX(w.weight) AS max, MIN(w.weight) AS min, w.reps_completed AS reps FROM workout_entries w INNER JOIN exercises e ON e.Id = w.exercise GROUP BY name ORDER BY name, reps';
